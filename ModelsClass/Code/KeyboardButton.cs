...
namespace ModelsNew
{
	...
	public class KeyboardButton
	{
		...
		/// </summary>
		/// <remarks>
		/// Default value: <see cref="ModelsNew.BackgroundMediaType.Picture"/>.
		/// Max size: 500 kb.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>Default value: <see cref="ModelsNew.TextVerticalAlign.Middle"/>.</remarks>
		...
		/// </summary>
		/// <remarks>Default value: <see cref="ModelsNew.TextHorizontalAlign.Center"/>.</remarks>
		...
		/// </summary>
		/// <remarks>Default value: <see cref="ModelsNew.TextSize.Regular"/>.</remarks>
